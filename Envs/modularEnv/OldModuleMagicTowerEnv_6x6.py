...
class OldModuleMagicTowerEnv_6x6(gym.Env):
    ...
    def __init__(self,render_mode = "human",size = 6):
        ...
        self.action_space = spaces.Box(low=np.array([0, 0, 0]), high=np.array([100, 100, 100]), dtype=np.float32)
    ...
    def step(self, action):
        self.curr_modular_index =np.argmax(action)
...
register(
    id='OldModuleMagicTowerEnv_6x6',
    entry_point='Envs.modularEnv.OldModuleMagicTowerEnv_6x6:OldModuleMagicTowerEnv_6x6',
